...
export const messageMap = {
  ...
  火曜日予定: () => ({
    type: 'text',
    text: '1、2、3、4限　コンピュータリテラシー　5、6限　英語　7、8限　コンピュータ理工学の勧め　9、10限　アカデミックスキル',
  }),
  水曜日予定: () => ({
    type: 'text',
    text: '1、2限　アカデミックスキル　3、4、5、6限　情報倫理',
  }),
  木曜日予定: () => ({
    type: 'text',
    text: '3、4、5、6限　線形代数　7、8限　体育',
  }),
  金曜日予定: () => ({
    type: 'text',
    text: '1、2、3、4限　コンピュータリテラシー　5、6限英語　7、8限　コンピュータ理工学の勧め',
  }),
  スタンプメッセージ: () => ({
    type: 'sticker',
    packageId: '446',
  ...
  ニュース: async () => {
    let newsApiRes;
    try {
      newsApiRes = (await get(`https://newsapi.org/v2/ top-headlines?country=jp&apiKey={process.env.newsApiKey}&pageSize=5`)).data;
    } catch (e) {
    ...
    articles.forEach((article) => {
      message.push({
        type: 'text',
        text: `【画像URL】 : ${article.urlToImage}¥n 【タイトル】: ${article.title}¥n 【公開日】: ${article.publishedAt}¥n 【概要】: ${article.description}¥n 【掲載元】: ${article.source.name}
        `,
      });
      return message;
    });
  ...
  会津大学ポケモンサークルについて: () => ({
    ...
    "template": {
      "type": "buttons",
      "thumbnailImageUrl": "https://pbs.twimg.com/profile_images/2225918472/icon1_400x400.png",
      "imageBackgroundColor": "#F9F9F9",
      "title": "会津大学ポケモンサークルについて",
      "text": "づっぽけの活動",
      "actions": [
        {
          "type": "message",
  ...
  活動内容: () => ({
    "type": "text",
    "text": "ゲームやカードゲームなどポケモンに関することやる。課題をやってる人とかもいる。",
  }),
  活動時間: () => ({
    "type": "text",
    "text": "月、水、金の各々授業終わりから22：00時くらいを活動時間にしている。自由参加、途中で帰ってもOKのアットホームなサークルです。",
  }),
  活動場所: () => ({
    "type": "text",
    "text": "北ラウンジか南ラウンジのどちらかでやってます。",
  }),
  'Flex': () => ({
    type: 'flex',
    altText: 'Flex Message',
    contents: {
      ...
      "hero": {
        "type": "image",
        "url": "https://pics.prcm.jp/9534c92f14ad1/85879190/jpeg/85879190_480x480.jpeg",
        "size": "xl",
      },
      "body": {
        "type": "box",
